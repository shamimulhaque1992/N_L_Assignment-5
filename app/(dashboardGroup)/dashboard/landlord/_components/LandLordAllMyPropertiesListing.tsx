...
import PropertyTableActionButtons from "./PropertyTableActionButtons";
...
import PropertyTableAvailabilityToggler from "./PropertyTableAvailabilityToggler";
...
const LandLordAllMyPropertiesListing = async ({
  searchParams,
}: {
...
export default LandLordAllMyPropertiesListing;
